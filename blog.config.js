...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Syngeneticlake', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个热爱游戏开发的程序员', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://Syngeneticlake.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Syngeneticlake, 博客', // 网站关键词 英文逗号隔开
